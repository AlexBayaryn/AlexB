...
import task5.sweetness.Sweetness;
import task5.sweetness.TypeSweetness;

import java.util.HashMap;
import java.util.Locale;
import java.util.Map;

import static task5.sweetness.TypeSweetness.*;
...
public class SweetGift {
    ...
    private void addSweetness(String name, int portion) {
        TypeSweetness type = TypeSweetness.valueOf(name);
